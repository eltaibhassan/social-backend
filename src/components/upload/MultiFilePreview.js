...
import { Iconify } from '../share/Iconify';
...
export default function MultiFilePreview({ showPreview = false, files, onRemove, onRemoveAll, onUploadFiles }) {
      ...
      {hasFile && (
        <Stack direction="row" justifyContent="flex-end" spacing={1.5}>
          <Button color="inherit" size="small" onClick={onRemoveAll}>
            {translate('information.remove_all')}
          </Button>
          <Button size="small" variant="contained" onClick={onUploadFiles}>
            {translate('information.upload_files')}
          </Button>
        </Stack>
      )}
    </>
